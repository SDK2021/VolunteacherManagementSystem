...
public class CoreController {
		...
		public ResponseEntity<Object> getDistrictsById(@PathVariable int id)
		{
			return coreService.districtById(id);
		}
		...
		public ResponseEntity<Object> updateVillage(@PathVariable int id,@RequestBody Village village)
		{
