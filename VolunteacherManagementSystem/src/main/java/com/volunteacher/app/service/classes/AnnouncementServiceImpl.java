...
public class AnnouncementServiceImpl implements AnnouncementService {
	...
	{
		Pageable pageable = PageRequest.of(page, 6,Sort.by("creation_date").descending());
		try {
			Page<Announcement> announcementList = (Page<Announcement>) announcementRepsitory.findAllAnnouncements(pageable);
