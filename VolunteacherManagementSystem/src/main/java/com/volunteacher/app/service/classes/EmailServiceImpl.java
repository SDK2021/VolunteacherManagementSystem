...
public class EmailServiceImpl implements EmailService {
	...
	public boolean sendMail(String mail,String otp,String name){
		try {
			...
			mimeMessageHelper.setFrom("airepindia@gmail.com");
...
//			mimeMessage.setContent("<div bgcolor=\"#f5f5f5\" dir=\"ltr\"><img src=\"https://firebasestorage.googleapis.com/v0/b/volunteacher-management-system.appspot.com/o/email_mast_logo.png?alt=media&token=a3aeadd0-ec65-4cdb-b511-c7ddd5b92ebf\" width=\"1\" height=\"1\">\r\n"
...
//					+ "                      <tbody>\r\n"
//					+ "                        <tr>\r\n"
//					+ "                          <td bgcolor=\"#ffffff\" id=\"m_1156825266702629747content\" style=\"line-height:24px;padding-top:0px;padding-right:0;padding-bottom:32px;padding-left:0;margin:0;background-color:#ffffff\"><img style=\"border:none\" src=\"https://firebasestorage.googleapis.com/v0/b/volunteacher-management-system.appspot.com/o/email_mast_logo.png?alt=media&token=a3aeadd0-ec65-4cdb-b511-c7ddd5b92ebf\" alt=\"Google \" width=\"700\" height=\"200\" class=\"CToWUd a6T\" tabindex=\"0\"><div class=\"a6S\" dir=\"ltr\" style=\"opacity: 0.01; left: 652.8px; top: 209.4px;\"><div id=\":1f8\" class=\"T-I J-J5-Ji aQv T-I-ax7 L3 a5q\" role=\"button\" tabindex=\"0\" aria-label=\"Download attachment \" data-tooltip-class=\"a1V\" data-tooltip=\"Download\"><div class=\"akn\"><div class=\"aSK J-J5-Ji aYr\"></div></div></div></div>    <table id=\"m_1156825266702629747sub-container\" style=\"border-collapse:collapse;color:#4d4d4d;font-size:16px;font-family:Roboto;width:600px;border-width:0\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\">\r\n"
//					+ "                          \r\n"
...
//					+ "<br>\r\n"
//					+ "<br>\r\n"
//					+ "You have <span class=\"il\">successfully</span> <span class=\"il\">registered</span> for Volunteaching in <b>A</b>ll <b>I</b>ndia <b>R</b>ural <b>E</b>mpowerment <b>P</b>rogram</b> . \r\n"					
...
//			mimeMessageHelper.setFrom("airepindia@gmail.com");
			...
			messageBodyPart.setContent("<div bgcolor=\"#f5f5f5\" dir=\"ltr\"><img src=\"https://firebasestorage.googleapis.com/v0/b/volunteacher-management-system.appspot.com/o/email-banner.png?alt=media&token=a33a2ace-70a7-4f54-a262-7b5812257707\" width=\"1\" height=\"1\">\r\n"
					+ "  <div id=\"m_1156825266702629747wrapper\" style=\"margin-right:auto;margin-top:0;margin-bottom:0;margin-left:auto\" dir=\"ltr\">\r\n"
					+ "    <table id=\"m_1156825266702629747email-container\" style=\"border-collapse:collapse;color:#4d4d4d;font-size:16px;font-family:Roboto;width:100%!important;background-color:#f5f5f5;border-width:0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#f5f5f5\">\r\n"
					+ "      <tbody>\r\n"
					+ "        <tr>\r\n"
					...
					+ "                      <tbody>\r\n"
					+ "                        <tr>\r\n"
					+ "                          <td bgcolor=\"#ffffff\" id=\"m_1156825266702629747content\" style=\"line-height:24px;padding-top:0px;padding-right:0;padding-bottom:32px;padding-left:0;margin:0;background-color:#ffffff\"><img style=\"border:none\" src=\"https://firebasestorage.googleapis.com/v0/b/volunteacher-management-system.appspot.com/o/email-banner.png?alt=media&token=a33a2ace-70a7-4f54-a262-7b5812257707\" alt=\"Google \" width=\"700\" height=\"200\" class=\"CToWUd a6T\" tabindex=\"0\"><div class=\"a6S\" dir=\"ltr\" style=\"opacity: 0.01; left: 652.8px; top: 209.4px;\"><div id=\":1f8\" class=\"T-I J-J5-Ji aQv T-I-ax7 L3 a5q\" role=\"button\" tabindex=\"0\" aria-label=\"Download attachment \" data-tooltip-class=\"a1V\" data-tooltip=\"Download\"><div class=\"akn\"><div class=\"aSK J-J5-Ji aYr\"></div></div></div></div>    <table id=\"m_1156825266702629747sub-container\" style=\"border-collapse:collapse;color:#4d4d4d;font-size:16px;font-family:Roboto;width:600px;border-width:0\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\">\r\n"
					+ "                          \r\n"
					+ "  <tbody><tr><td><table style=\"border-collapse:collapse;color:#4d4d4d;font-size:16px;font-family:Roboto;color:black;border-width:0\" cellspacing=\"0\" cellpadding=\"0\">\r\n"
					+ "                              <tbody>\r\n"
					+ "                                <tr>\r\n"
			...
			String attachFile = "C:\\Users\\Suhanee Mavar\\Desktop\\AIREP_ppt.pdf";
	...
	public boolean participantSuccessfullyMail(String mail, String name, Event event) {
		...
		try {
			...
			//
			String activities = "Sorry, No Activities in event"; 
			if(event.getActivities().size() > 0)
			{
				List<Activity> activityList =  event.getActivities();
				int i = 0;
				for (Activity activity : activityList) {
					if(i==0)
					{
						activities = activity.getActivityName() + " ";
					}
					else 
					{
						activities += activity.getActivityName() +" ";
...
//					, "text/html");
			...
			mimeMessage.setContent("<table bgcolor=\"#ffffff\" width=\"600\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\" style=\"border-collapse:collapse;border-spacing:0;background-color:#ffffff\">\r\n"
					...
					+ "                                                                                    <img style=\"max-width:200px;vertical-align:bottom\" src="+ event.getPhoto() +" alt=\"logo\" class=\"CToWUd\">\r\n"
					+ "                                                                                </td>\r\n"
					+ "                                                                            </tr>\r\n"
					+ "                                                                            <tr>\r\n"
					...
					+ "                                                                                                                    										<b>A</b>ll <b>I</b>ndia <b>R</b>ural <b>E</b>mpowerment <b>P</b>rogram</b> .										</td>\r\n"
					+ "                                                                                                                </tr>\r\n"
					+ "                                                                                                                <tr>\r\n"
					+ "                                                                                                                    <td style=\"line-height:0;font-size:0;vertical-align:top;padding:0px;text-align:left\" height=\"16\">&nbsp;</td>\r\n"
					+ "                                                                                                                </tr>\r\n"
					+ "                                                                                                                <tr>\r\n"
					+ "                                                                                                                    <td style=\"margin:0;padding:0;font-size:18px;text-align:center;color:#ffffff;line-height:22px;font-family:Helvetica,Arial,sans-serif;font-weight:bold;text-transform:capitalize\">"+"Place:" + event.getVillage().getVillageName() + "-Village  "+event.getVillage().getTaluka().getDistrict().getDistrictName()+" , "+event.getVillage().getTaluka().getDistrict().getState().getStateName()+"</td>\r\n"
					+ "                                                                                                                </tr>\r\n"
					+ "                                                                                                                <tr>\r\n"
					+ "                                                                                                                    <td style=\"line-height:0;font-size:0;vertical-align:top;padding:0px;text-align:left\" height=\"16\">&nbsp;</td>\r\n"
					+ "                                                                                                                </tr>\r\n"
					...
					+ "                                                                                                                            </tr>\r\n"
					+ "                                                                                                                            <tr>\r\n"
					+ "                                                                                                                                <td style=\"margin:0;padding:0;font-size:16px;text-align:left;color:#4b4649;line-height:21px;font-family:Helvetica,Arial,sans-serif;font-weight:bold\">Activities:</td>\r\n"
					+ "                                                                                                                            </tr>\r\n"
					+ "                                                                                                                            <tr>\r\n"
					+ "                                                                                                                                <td style=\"line-height:0;font-size:0;vertical-align:top;padding:0px;text-align:left\" height=\"8\">&nbsp;</td>\r\n"
					+ "                                                                                                                            </tr>\r\n"
...
//					+ "</div></div></div></center>", "text/html");
			System.out.println("req"+request.getRequestId());
				...
				mimeMessage.setContent("<div style=\"margin:0;padding:0\" dir=\"ltr\" bgcolor=\"#ffffff\">"
					...
					+ "<tr><td width=\"15px\" style=\"width:15px\"></td><td style=\"line-height:0px;max-width:600px;padding:0 0 15px 0\"><table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"border-collapse:collapse\"><tbody><tr><td style=\"width:100%;text-align:left;height:33px\"><img height=\"100\" src=\"https://firebasestorage.googleapis.com/v0/b/volunteacher-management-system.appspot.com/o/URL-V-LOGO.png?alt=media&token=d1640b83-882f-4e30-8e38-df613006c5d6\" style=\"border:0\" class=\"CToWUd\"></td></tr></tbody></table>"
					...
					+ "</a></td></tr><tr><td height=\"10\" style=\"line-height:10px\" colspan=\"1\">&nbsp;</td></tr><tr><td><p style=\"margin:10px 0 10px 0;color:#565a5c;font-size:18px\">If you will not be able to login into our system then feel free to send a mail on <a href='mailto:airepindia@gmail.com'\"\">Email id.</a>.</p></td></tr></tbody></table></td><td width=\"20\" style=\"display:block;width:20px\">&nbsp;&nbsp;&nbsp;</td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr><tr><td><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"border-collapse:collapse;margin:0 auto 0 auto;width:100%;max-width:600px\"><tbody><tr><td height=\"4\" style=\"line-height:4px\" colspan=\"3\">&nbsp;</td></tr><tr><td width=\"15px\" style=\"width:15px\"></td><td width=\"20\" style=\"display:block;width:20px\">&nbsp;&nbsp;&nbsp;</td><td style=\"text-align:center\"><div style=\"padding-top:10px;display:flex\">"
